...
"""
Important note! The order in which we define these routes ABSOLUTELY DOES MATTER. 
If we were to put the /stats/ route after our evaluations:get-evaluation-for-cleaner route, 
that stats route wouldn't work. FastAPI would assume that "stats" is the ID of a 
cleaning and throw a 422 error since "stats" is not an integer id.
"""
