...
async def get_cleaning_by_id(
    id: UUID, cleanings_repo: CleaningsRepository = Depends(get_repository(CleaningsRepository))
) -> CleaningPublic:
...
async def update_cleaning_by_id(
    id: UUID = Path(..., title="The ID of the cleaning to update."),
...
@router.delete("/{id}/", response_model=UUID, name="cleanings:delete-cleaning-by-id")
async def delete_cleaning_by_id(
    id: UUID = Path(..., title="The ID of the cleaning to delete."),
    cleanings_repo: CleaningsRepository = Depends(
        get_repository(CleaningsRepository)),
) -> UUID:
