...
class EvaluationBase(CoreModel):
    no_show: bool = False
    headline: Optional[constr(strip_whitespace=True, max_length=254)]
    comment: Optional[constr(strip_whitespace=True)]
